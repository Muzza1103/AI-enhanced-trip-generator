    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to ApiTraveller, accessible from <a
                        href="http://localhost:3000/privacypolicy" rel="external nofollow noopener"
                        target="_blank">http://localhost:3000/privacypolicy</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: ApiTraveller@gmail.com</li>
            </ul>
        </div>
    );
};
