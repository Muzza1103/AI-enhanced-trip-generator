...
import com.l3g1.apitraveller.model.enumeration.Transport;
import lombok.Data;
...
public class City {
    ...
    public City(String cityName, Climate climate, List<Temperature> temperatureList,
                Landscape landscape, String description, List<Transport> transportList, Country country, List<Activity> activityList) {
        this.cityName = cityName;
        this.climate = climate;
    ...
    public void addTemperature(Temperature temperature) {
        if(!transportList.contains(temperature)){
            this.temperatureList.add(temperature);
        }
    }
