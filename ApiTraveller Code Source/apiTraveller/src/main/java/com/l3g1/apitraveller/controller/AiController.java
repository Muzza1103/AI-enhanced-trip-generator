...
public class AiController {
	...
	// Endpoint to test a request to the AI
	@GetMapping ("/chatCity/{countryName}")
	public String chatCity(@PathVariable String countryName) {
		// Constructing the prompt
		StringBuilder promptBuilder = new StringBuilder();
		promptBuilder.append("Give me a city of "+countryName+", three activities in the activityList in the following format, here are the possible values for these attributes: "+climateValues+" "+landscapeValues+" "+temperatureValues+" "+transportValues+" "+activityTypeValues+", :");
		promptBuilder.append("{\n");
		promptBuilder.append("    \"cityName\": \"\",\n");
		promptBuilder.append("    \"climate\": \"\",\n");
		promptBuilder.append("    \"temperatureList\": \"[]\",\n");
		...
		promptBuilder.append("        \"countryName\": \""+countryName+"\"\n");
		promptBuilder.append("    }\n");
		promptBuilder.append("}\n");
