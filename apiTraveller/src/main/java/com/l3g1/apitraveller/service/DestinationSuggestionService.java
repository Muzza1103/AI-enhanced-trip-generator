...
public class DestinationSuggestionService {
	...
	public Iterable<Suggestion>getSuggestion(Survey survey) throws IllegalArgumentException{
	...
	@SneakyThrows
	public Iterable<Suggestion>getSuggestionAI (Survey survey) throws IllegalArgumentException{
